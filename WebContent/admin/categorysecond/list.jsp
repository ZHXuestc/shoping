					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<!-- status="status"属性是记录循环信息的，可以记录下标，在遍历数组或集合的时候可以获取它的下标，可以记录遍历的是奇数个还是偶数个，还可以记录遍历的个数 -->
								<s:iterator var="cs" value="pageBean.list" status="status">
									...
									<td align="center" width="18%" colspan="4">
										第<s:property value="pageBean.currentPage"/>/<s:property value="pageBean.totalPage"/>
										<s:if test="pageBean.currentPage !=1">
											<a href="${pageContext.request.contextPath}/categorySecond_adminFindAll.action?page=1">首页</a> |
											<a href="${pageContext.request.contextPath}/categorySecond_adminFindAll.action?page=<s:property value="pageBean.currentPage-1"/>">上一页</a> |
										</s:if>
										<s:if test="pageBean.currentPage !=pageBean.totalPage">
											<a href="${pageContext.request.contextPath}/categorySecond_adminFindAll.action?page=<s:property value="pageBean.currentPage+1"/>">下一页</a> |
