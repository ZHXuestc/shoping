								...
								<tr
									...
									<td align="left" width="10%" colspan="5">
										...
										<s:elseif test="#order.state==2">
											<a href="${pageContext.request.contextPath }/order_adminUpdateState.action?oid=<s:property value="#order.oid"/>">发货</font></a>
										</s:elseif>
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" width="18%" colspan="8">
										...
										<s:if test="pageBean.currentPage != 1">
											...
											<a href="${ pageContext.request.contextPath }/order_adminFindAll.action?page=<s:property value="pageBean.currentPage-1"/>">上一页</a> |
										</s:if>
										<s:if test="pageBean.currentPage != pageBean.totalPage">
											<a href="${ pageContext.request.contextPath }/order_adminFindAll.action?page=<s:property value="pageBean.currentPage+1"/>">下一页</a> |
