								...
								<tr
									...
									<s:iterator var="p" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
												<img width="75" height="65" src="${pageContext.request.contextPath }/<s:property value="#p.image"/>"/>
											</td>
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
									...
									<td align="center" width="18%" colspan="8">
										...
										<s:if test="pageBean.currentPage != 1">
											...
											<a href="${ pageContext.request.contextPath }/product_adminFindAll.action?page=<s:property value="pageBean.currentPage-1"/>">上一页</a> |
										</s:if>
										<s:if test="pageBean.currentPage != pageBean.totalPage">
											<a href="${ pageContext.request.contextPath }/product_adminFindAll.action?page=<s:property value="pageBean.currentPage+1"/>">下一页</a> |
