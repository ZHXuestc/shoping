			...
			<ul>
				<s:if test="#session.userExit!=null">
					<li id="headerLogin" class="headerLogin" style="display: list-item;">
						<s:property value="#session.userExit.name"/>|
					</li>
					<li id="headerLogin" class="headerLogin" style="display: list-item;">
						<a href="${ pageContext.request.contextPath }/order_myOrder.action?uid=<s:property value="#session.userExit.uid"/>&page=1">我的订单</a>|
					</li>
