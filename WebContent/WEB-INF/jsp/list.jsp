...
<div class="pagination">
		第  <s:property value="pageBean.currentPage"/>/<s:property value="pageBean.totalPage"/>页
			...
			<s:if test="pageBean.currentPage != 1">
				...
				<a href="${ pageContext.request.contextPath }/product_findByCid.action?cid=<s:property value="cid"/>&page=<s:property value="pageBean.currentPage-1"/>" class="previousPage">&nbsp;</a>	
			</s:if>	
			...
			<s:if test="pageBean.currentPage != pageBean.totalPage">
				<a class="nextPage" href="${ pageContext.request.contextPath }/product_findByCid.action?cid=<s:property value="cid"/>&page=<s:property value="pageBean.currentPage+1"/>">&nbsp;</a>
