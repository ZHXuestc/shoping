						...
						<table>
							<tbody>
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text" id="checkCode" name="checkCode" class="text captcha" maxlength="4" autocomplete="off">
									<img id="checkImg" class="captchaImage" onclick="change()"
