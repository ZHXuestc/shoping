...
<script type="text/javascript">
  function change(){
	  ...
	  img.src = "${pageContext.request.contextPath}/verifyCode.action?" + new Date().getTime();
  }
					...
					<form id="loginForm" action="${pageContext.request.contextPath }/user_login.action" method="post" novalidate="novalidate">
						<table>
							<tbody><tr>
								...
								<td>
									<input type="text" id="username" name="username" class="text" maxlength="20"><span><s:fielderror fieldName="username" />
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="password" id="password" name="password" class="text" maxlength="20" autocomplete="off"><span><s:fielderror fieldName="password" />
								</td>
							</tr>
								<tr>
									<th>
									...
									<td>
										<span class="fieldSet">
											...
											<img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath }/verifyCode.action" title="点击更换验证码" onclick="change()">
										</span>
									</td>
								</tr>
							<tr>
